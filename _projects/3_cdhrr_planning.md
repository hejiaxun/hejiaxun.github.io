...
<section class="interactive-feature interactive-feature--cast" aria-labelledby="cast-interactive-title">
  <div class="interactive-feature-head">
    <div>
      <p class="eyebrow">CAST Interactive</p>
      <h2 id="cast-interactive-title">交互式方法与评测浏览器</h2>
      <p>直接浏览机器人系统、九类 Benchmark、方法链、对比结果与仿真—实测标定；可在交互页内切换中英文。</p>
    </div>
